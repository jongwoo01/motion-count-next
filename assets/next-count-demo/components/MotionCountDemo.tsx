...
export function MotionCountDemo() {
    ...
    switch (tracking.trackingState) {
      case 'idle':
        return {
          ...
          title: '손가락 수가 입자 숫자가 됩니다',
          body: '카메라를 켜고 손을 들어보세요. 펼친 손가락 개수만큼 숫자와 위 네모 배지가 실시간으로 바뀝니다.',
          action: '카메라 시작',
        }
  ...
  return (
    <main className="app-shell">
      ...
      <video ref={videoRef} className="camera-capture" muted playsInline />
      ...
      <section className="scene-overlay">
        <header className="title-lockup">
          ...
          <p className="title-lockup__body">
            지금 감지된 숫자는 {tracking.fingerCount}입니다.
          </p>
        </header>
        ...
        <section className="info-dock info-dock--count-only">
          ...
          <section className="gesture-legend" aria-label="카운트 안내">
            ...
            <span><strong>양손</strong> 0부터 10까지</span>
          </section>
        </section>
      </section>
